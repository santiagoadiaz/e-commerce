    ...
    return (
        <>
            {carrito.length === 0 ?
                <>
                    <h1>Carrito vacio</h1>
                    <button className={`btn btn-secondary btn-primary`}><Link className="nav-link" to={'/'}>Continuar comprando</Link></button>
                </>
                :
                <div className="container cartContainer">
                    ...
                    <div className="divButtons">
                        ...
                        <button className={`btn 'btn-secondary'  'btn-primary`}><Link className="nav-link" to={'/'}>Continuar comprando</Link></button>
                        <button className={`btn 'btn-secondary'  'btn-primary`}><Link className="nav-link" to={'/checkout'}>Finalizar Compra</Link></button>
                    </div>
                </div>
