            ...
            <header className='sticky-top'>
                ...
                <nav className="align-items-center container-fluid margin-header w-100 d-flex justify-content-between ghost">
                    ...
                    <label htmlFor="cartfill-menu">
                        <Link to={"/carrito"}><img src="https://firebasestorage.googleapis.com/v0/b/chunis-petshop-1.appspot.com/o/Imagenes%2Fcart-plus.svg?alt=media&token=fb63bbed-e0ae-41e0-bd9f-dfe6d7b6552f" className=" icon-cart-plus logo d-inline-block align-text-top" /></Link>
                    </label>
                    {/* chunis */}
                    <Link to={"/"}>
                ...
                <nav className="navbar fixed-top ghost-pages">
                    <div className="d-flex justify-content-between ms-4 me-4">
                        {/* carrito */}
                        <Link to={"/carrito"}><img src="https://firebasestorage.googleapis.com/v0/b/chunis-petshop-1.appspot.com/o/Imagenes%2Fcart-plus.svg?alt=media&token=fb63bbed-e0ae-41e0-bd9f-dfe6d7b6552f" className=" icon-cart-plus logo" /></Link>
                        {/* logo chunis */}
